...
public class PrimaryController {
    ...
    @FXML
    public TextField name, umschulung, wocheVon, wocheBis, jahr, datumAuszubildenden, datumAusbildender;
    @FXML
    public Label tag1, tag2, tag3, tag4, tag5;
    @FXML
    public TextField stunden1, stunden2, stunden3, stunden4, stunden5, gesamtStunden;
    @FXML
    public MenuButton menuButton;
    @FXML
    public MenuItem menuSpeichernUndDrucken, menuSpeichern, menuDrucken, menuLaden, chatbot;

    @FXML
    public void aiFragen(ActionEvent e) throws IOException {
        aiFenster = new Stage();
    ...
    public void speichern(ActionEvent e) throws Exception {
        ...
        fileChooser.setInitialDirectory(new File(
                "C:\\Users\\DejanKrstovski\\OneDrive - BBQ - Baumann Bildung und Qualifizierung GmbH\\Dokumente"));
    ...
    @FXML
    public void laden(ActionEvent e) throws JAXBException {
    ...
    @FXML
    public void updateStunde(KeyEvent e) {
    ...
    public void updateDatum(KeyEvent e) {
        try {
            LocalDate vonDatum = LocalDate.parse(wocheVon.getText() + jahr.getText(),
